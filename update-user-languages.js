...
const userLanguageUpdates = [
    ...
    {
        email: 'test11@tabbimate.test',
        languages: [
            { language: 'Spanish', level: 'Native' },
            { language: 'English', level: 'Intermediate' },
            { language: 'Korean', level: 'Basic' }
        ],
        interests: ['Multilingual', 'Travel', 'Photography'],
        bio: 'Spanish speaker learning English and Korean'
    },
    {
        email: 'test12@tabbimate.test',
        languages: [
            { language: 'English', level: 'Native' },
            { language: 'Spanish', level: 'Professional' }
        ],
        interests: ['Spanish Literature', 'Culture', 'Teaching'],
        bio: 'English native with professional Spanish'
    },
    {
        email: 'test13@tabbimate.test',
        languages: [
            { language: 'Korean', level: 'Native' },
            { language: 'Spanish', level: 'Intermediate' }
        ],
        interests: ['Spanish Language', 'Latin Culture', 'Music'],
        bio: 'Korean speaker learning Spanish'
    },
    {
        email: 'test14@tabbimate.test',
        languages: [
            { language: 'Spanish', level: 'Native' },
            { language: 'Korean', level: 'Professional' }
        ],
        interests: ['Korean Business', 'Translation', 'Culture'],
        bio: 'Spanish speaker with professional Korean skills'
    },
    {
        email: 'test15@tabbimate.test',
        languages: [
            { language: 'English', level: 'Native' },
            { language: 'Korean', level: 'Intermediate' },
            { language: 'Spanish', level: 'Basic' }
        ],
        interests: ['Language Learning', 'Travel', 'Culture'],
        bio: 'English native learning Korean and Spanish'
    },
    {
        email: 'test16@tabbimate.test',
        languages: [
            { language: 'Korean', level: 'Native' },
            { language: 'English', level: 'Basic' }
        ],
        interests: ['English Learning', 'Gaming', 'Movies'],
        bio: 'Korean speaker starting English'
    },
    {
        email: 'test17@tabbimate.test',
        languages: [
            { language: 'Spanish', level: 'Native' },
            { language: 'English', level: 'Professional' },
            { language: 'Korean', level: 'Intermediate' }
        ...
        bio: 'Trilingual Spanish native'
    },
    {
        email: 'test18@tabbimate.test',
        languages: [
            { language: 'English', level: 'Native' },
            { language: 'Spanish', level: 'Intermediate' }
        ],
        interests: ['Spanish Culture', 'Cooking', 'Travel'],
        bio: 'English speaker learning Spanish'
    },
    {
        email: 'test19@tabbimate.test',
        languages: [
            { language: 'Korean', level: 'Native' },
            { language: 'English', level: 'Professional' },
            { language: 'Spanish', level: 'Intermediate' }
        ],
        interests: ['Business', 'Languages', 'International Trade'],
        bio: 'Korean professional learning Spanish'
    },
    {
        email: 'test20@tabbimate.test',
        languages: [
            { language: 'Spanish', level: 'Native' },
            { language: 'English', level: 'Basic' }
        ],
        interests: ['English Learning', 'Music', 'Sports'],
        bio: 'Spanish speaker beginning English'
    }
];
